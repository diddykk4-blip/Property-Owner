...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function navigateTo(targetId) {
        const map = {
            'screen-a': 'index.html',
            'screen-b': 'step-1.html',
            'screen-c': 'step-2.html',
            'screen-d': 'step-3.html',
            'screen-e': 'step-4.html',
            'screen-f': 'step-5.html',
            'screen-g': 'success.html'
        };
        if (map[targetId]) {
            window.location.href = map[targetId];
        }
    }
